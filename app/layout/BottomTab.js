...
function BottomTab({ state, descriptors, navigation }) {
    ...
    return (
        ...
        <DropShadow
            style={[GlobalStyleSheet.shadow,Platform.OS === 'ios' && {backgroundColor:colors.card}]}
        >
            <View style={{ flexDirection: 'row', height: 60, backgroundColor: colors.card, alignItems: 'center' }}>
                <Animated.View
                    style={{
                        position: 'absolute',
                        height: '100%',
